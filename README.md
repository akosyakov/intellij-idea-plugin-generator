...
## Download Eclipse plugins and add them into plugins directory of your eclipse.
...
## Create or open xText project, define grammar, launch generator and export plugins.

## Add Intellij IDEA plugin generator plugin as dependency to your xText project.

1. Open META-INF/MANIFEST.MF -> Dependencies -> Add... -> Select org.eclipse.xtext.generator.idea -> OK -> Save manifest

## Edit Language Generation workflow.
...
## Run Language Generation workflow and export plugins again.
...
## Open Intellij IDEA (supported version 12 and above) and open the generated Intellij IDEA language plugin.
...
## Run Intellij IDEA Language Plugin
...
## Deploy Intellij IDEA Language Plugin
